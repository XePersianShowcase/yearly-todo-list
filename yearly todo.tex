...
\newif\ifEitherLeap
\EitherLeapfalse
\isLeapYear{\ThisYear}\EitherLeaptrue\else\EitherLeapfalse\fi
\ifPersianLeap\EitherLeaptrue\fi
\ThisDay{\ifEitherLeap 19\else20\fi}
...
\count2=\ifEitherLeap 81\else80\fi % the first day of Jalali calendar is the 80th/81st of the Gregory calendar
...
\begin{document}
    ...
    % \yearlytodo{1405}% first day of 1404 is Saturday
    \yearlytodo{1404}
\end{document}
