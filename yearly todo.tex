...
\renewcommand\is@LeapYear[1][\year]{\r@k#1\un@r\r@k
  \global\divide\r@k4\multiply\r@k4\advance\r@k-\un@r
  \ifnum\r@k=0%
      \divide\un@r100\r@k\un@r\multiply\un@r100\advance\un@r-#1%
    \ifnum\un@r=0%
      \global\un@r\r@k \divide\un@r4\multiply\un@r4\advance\un@r-\r@k
      \global\un@r\ifnum\un@r=0 29\else 28\fi
    \else
      \global\un@r 29%
    \fi
  \else
    ...
    \foreach \x in {1,2}{%
        ...
        \begin{tikzpicture}%[xshift=-1cm, scale=1.3]
            ...
            \foreach \x in \xrangeR{% {14.6,14.2,...,8.6}{
                ...
                \node at (\x, 19.75) {{\tiny\ttfamily\AdvanceDate[1]\the\day}};
