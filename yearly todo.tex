...
\makeatletter
\def\mymonth#1#2#3{% index the starting day of a month
\newif\ifsixteen \sixteentrue
\def\thisyear{#1}
    ...
    \foreach \x in {1,2}{%
        ...
        \begin{tikzpicture}%[xshift=-1cm, scale=1.3]
            ...
            \foreach \x in \xrangeR{% {14.6,14.2,...,8.6}{
                ...
                \node [rotate=90, anchor=east] at (\x, 19.7) {\small\scshape\ttfamily\dm};
                \node [xshift=-.5mm]at (\x, 19.75) {{\tiny\scshape\ttfamily\AdvanceDate\the\day}};
...
\begin{document}
    %\mymonth{1400}{1}{21/3/2021} % first day of 1400 is Sunday
    \mymonth{1401}{2}{21/3/2022} % first day of 1401 is Monday
\end{document}
