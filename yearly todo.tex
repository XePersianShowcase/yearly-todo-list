...
\ifin@\PersianLeaptrue\else\global\PersianLeapfalse\fi
}
\makeatother
...
\count2=\ifPersianLeap81\else80\fi % the first day of Jalali calendar is the 80th/81st of the Gregory calendar
...
\begin{document}
    ...
    \yearlytodo{1403}% first day of 1401 is Monday
    \yearlytodo{1404}% first day of 1402 is Tuesday
\end{document}
